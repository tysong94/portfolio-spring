...
//       Reservation r = reservationDao.selectOne(1);
//       assertEquals(1, r.getId());
//	}
	@Test
	public void testSelectOneByDateRoom() throws Exception {
		Calendar cal = Calendar.getInstance();
		Reservation r = reservationDao.selectOneByDateRoom(cal.getTime(), 1);
		assertEquals(3, r.getRoom().getType());
	}
//    
//    @Test
